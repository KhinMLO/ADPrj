    ...
    public partial class LoginPage : System.Web.UI.Page
    {
            ...
            if (txtEmployeeID.Text != "" && txtPIN.Text != "")
            {
                ...
                switch (usertype)
                {
                    ...
                    case "StoreFound":
                        ...
                        Session["User"] = semp;
                        Session["Name"] = semp.Name;
                        Response.Redirect("~/WebView/Notifications.aspx");
                        break;
                    case "EmployeeFound":
                        Model.Employee emp = loginCrt.getEmployeeUserObject(txtEmployeeID.Text);
                        if (emp == null)
                ...
                lblMessage.Text = "Enter Employee ID";
            else if (txtEmployeeID.Text == "")
                lblMessage.Text = "Enter PIN Number";
        }
        ...
        protected void lkBtnForgotPassword_Click(object sender, EventArgs e)
        {
            ...
            if (result.Equals("Found"))
                ...
                lblMessage.Text = "Input Valid UserID";
