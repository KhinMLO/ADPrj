...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div style="width:90%; margin-left:37%;">
    <asp:Label ID="lblTitle"  style="font-family:'Arial Rounded MT'; 
font-weight:bold; font-size:40px;"
        runat="server" 
        Text="Delegate Authority"></asp:Label>
         <asp:ValidationSummary ID="ValidationSummary1" runat="server" ForeColor="Red" ValidationGroup="frmDelegateAuth" />

         <asp:Label ID="lblMessage" runat="server" Text=""></asp:Label>
         </div>
          <div style="width:90%; margin-left:35%;">
&nbsp;<table class="auto-style1" style="width:50%; border:none;">
        <tr>
...
font-size:16px; Height:36px; Width:180px;"></asp:DropDownList></td>
...
font-family:Arial; font-size:19px;"
            ...
            <td>
                <asp:TextBox ID="tbxFromDate" runat="server" 
                    style="box-shadow: 5px 5px 8px grey; font-family:Arial; font-size:16px; Height:36px; Width:180px;"
                    ></asp:TextBox>
...
font-family:Arial; font-size:19px;"
            ...
            <td>
                <asp:TextBox style="box-shadow: 5px 5px 8px grey; font-family:Arial; font-size:16px;Height:36px; Width:180px;" ID="tbxToDate" runat="server"></asp:TextBox>
...
font-family:Arial; font-size:19px;"
        ...
        <tr>
            <td colspan="3" style="align-content:center">&nbsp;</td>
        </tr>
    </table>
   
    <div id="mainContainer" class="container" style="width:98%; position:relative; margin-left:-32%;" >  
            <div class="shadowBox">                           
                                <div class="table-responsive">
    
    <asp:Label ID="lblDeptDelGVTitle" style="font-family:'Arial Rounded MT'; 
font-weight:bold; font-size:40px; margin-left:37%;"
