...
namespace LogicUniversity.WebView.Employee
{
    public partial class Disbursements : System.Web.UI.Page
    {
        ...
        private void checkRequestQueryString()
        {
            ...
            if (Request.QueryString["DisbursementID"] != null)
            {
                if (int.TryParse(Request.QueryString["DisbursementID"], out currDisbursementID))
                {
                    ...
                    Session["DID"] = currDisbursementID.ToString();
        ...
        protected void gvDisbursement_RowCreated(object sender, GridViewRowEventArgs e)
        {
        ...
        protected void gvDisbursementDetails_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            gvDisbursementDetails.PageIndex = e.NewPageIndex;
            int currDisbursementID = Convert.ToInt32(Session["DID"].ToString());
            //Model.Delegate editDelegate;
            getSessionData();
            if (Request.QueryString["DisbursementID"] != null)
            {
        ...
        protected void gvStoreDisbursementDetails_RowCreated(object sender, GridViewRowEventArgs e)
        {
            e.Row.Cells[0].Style.Add("display", "none");
        }

        protected void gvStoreDisbursementDetails_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            gvStoreDisbursementDetails.PageIndex = e.NewPageIndex;
            int currDisbursementID = Convert.ToInt32(Session["DID"].ToString());
            //Model.Delegate editDelegate;
            getSessionData();
            if (Request.QueryString["DisbursementID"] != null)
        ...
        protected void gvAllDeptDisbursement_RowCreated(object sender, GridViewRowEventArgs e)
        {
            e.Row.Cells[0].Style.Add("display", "none");
        }

        protected void gvAllDeptDisbursement_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            gvAllDeptDisbursement.PageIndex = e.NewPageIndex;
            getDisbursementList();
        }
