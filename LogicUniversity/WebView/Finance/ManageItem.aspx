...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="margin-left:35%;">
        <tr>
            <td colspan="2"><asp:Label ID="Label1" runat="server" 
                style="font-family:'Arial Rounded MT'; font-weight:bold; font-size:30px; margin-left:22%;"
        ...
        <tr>
            ...
            <td class="auto-style2"><asp:TextBox ID="txtItemID" 
                style="box-shadow: 5px 5px 7px grey;
                        font-family:Arial; font-size:16px;"  runat="server" Height="30px" Width="179px"></asp:TextBox></td>
            <td>
      ...
      ControlToValidate="txtItemID"></asp:RequiredFieldValidator>
        ...
        <tr>
            ...
            <td class="auto-style2"><asp:TextBox style="box-shadow: 5px 5px 7px grey;
                ...
                Height="30px" Width="179px"></asp:TextBox></td>
            <td>
        ...
        <tr>
            ...
            <td class="auto-style2"><asp:TextBox 
                ID="txtQuantity" style="box-shadow: 5px 5px 7px grey;
                        font-family:Arial; font-size:16px;"
                Height="30px" Width="179px" runat="server"></asp:TextBox></td>
            <td>
    ...
    ErrorMessage="Please Enter Only Numbers" ValidationExpression="^\d+$"/>  
        ...
        <tr>
          ...
          ErrorMessage="*Required"
      ControlToValidate="txtUOM" ></asp:RequiredFieldValidator>
                    </td>
        </tr>
        <tr>
                  <td>&nbsp;</td>
        ...
        <tr>
          ...
          ErrorMessage="*Required"
      ControlToValidate="txtReorderLevel" ></asp:RequiredFieldValidator>
    ...
    ErrorMessage="Please Enter Only Numbers" ValidationExpression="^\d+$"/> 
        ...
        <tr>
          ...
          ErrorMessage="*Required"
      ControlToValidate="txtReorderQuantity" ></asp:RequiredFieldValidator>
        ...
        <tr>
            ...
            <td class="auto-style2">
                <asp:TextBox style="box-shadow: 5px 5px 7px grey;
                        font-family:Arial; font-size:16px;"
                    ID="txtBinNo" Height="30px" Width="179px" runat="server"></asp:TextBox></td>
            <td>
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" 
          ErrorMessage="*Required"
      ControlToValidate="txtBinNo" ></asp:RequiredFieldValidator>
                    </td>
        </tr>
        <tr>
                  <td>&nbsp;</td>
        ...
        <tr>
           ...
           &nbsp; &nbsp; &nbsp; &nbsp;
            &nbsp; &nbsp;</td>
            <td><asp:Button CssClass="btn-custom11"    
                    style="box-shadow: 5px 5px 10px grey;" class="btn btn-lg btn-block btn-info"
